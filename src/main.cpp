    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          process_sensor_measurment(iss, ukf, estimations, measured_positions, ground_truth);
...
void print_usage() {
  cout << "Run as server mode: ./UnscentedKF" << endl;
  cout << "Load data file: ./UnscentedKF path_to_data_file" << endl;
  cout << endl;
}
