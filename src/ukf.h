...
public:
  ...
  void SigmaPointPrediction(const MatrixXd& Xsig, double delta_t, MatrixXd* Xsig_out);
  ...
  void PredictMeanMeasurementAndCovarianceMetrix(
  ...
  // normalize angles so that angles are between −π and π
